...
<head>
  ...
  <style>
    :root {
      --bg: #0d1017;
      --text: #f5f7fb;
      --muted: rgba(227,232,242,0.74);
      --soft: rgba(227,232,242,0.54);
      --accent: #60a5fa;
    ...
    body {
      ...
      background:
        ...
        linear-gradient(180deg, #040507 0%, #07090d 22%, var(--bg) 52%, var(--bg) 100%);
      color: var(--text);
    ...
    article { padding: 36px 0 0; font-size: 19px; line-height: 1.9; color: rgba(245,247,251,0.92); }
